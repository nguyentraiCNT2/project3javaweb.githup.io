...
const OrderListByCancelbad= () => {
  ...
  const fetchOrders = async () => {
    try {
      const response = await axios.get(`/order/api/oder/ordercancel/list/Đã hủy?page=${page}&limit=${limit}`);
...
export default OrderListByCancelbad;
