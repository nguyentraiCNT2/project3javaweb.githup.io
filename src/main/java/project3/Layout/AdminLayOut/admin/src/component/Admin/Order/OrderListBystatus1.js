...
const OrderListByStatus1 = () => {
  ...
  const fetchOrders = async () => {
    try {
      const response = await axios.get(`/order/api/oder/orderstatus/list/đang chuẩn bị hàng?page=${page}&limit=${limit}`);
          ...
          <div className="container d-flex flex-column">
            <div className="card shadow mb-4">
              ...
              <div className="card-body">
                <Link to="/tao-don-hang" className="btn btn-primary mt-3"> Tạo đơn hàng</Link>
                ...
                {selectedOrder && (
                  <div>
                    ...
                    {/* <OrderForm order={selectedOrder} onCancel={handleCancelEdit} /> */}
                  </div>
                )}
...
export default OrderListByStatus1;
