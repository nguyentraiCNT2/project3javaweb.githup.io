...
const OrderListByStatus2 = () => {
  ...
  const fetchOrders = async () => {
    try {
      const response = await axios.get(`/order/api/oder/orderstatus/list/đang giao?page=${page}&limit=${limit}`);
...
export default OrderListByStatus2;
